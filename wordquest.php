...
if ( !isset( $wqfunctions[$funcname] ) || !is_callable( $wqfunctions[$funcname] ) ) {
 $wqfunctions[$funcname] = function() {
	...
	// 1.8.3: added right margin for plugin icon
		...
		jQuery('li a').each(function() {
			...
			if (position > -1) {
				...
				if (linkref == 'admin.php?page='+slug) {
					jQuery('<img src=\"'+iconurl+'\" style=\"float:left;margin-top:3px;margin-left:3px;margin-right:3px;\">').insertBefore(jQuery(this));
