...
// Loader Usage
// ============
// 1. replace all occurrences of gfo_ in this file with the plugin namespace prefix eg. my_plugin_
...
// $instance = new gfo_loader($args);				// instantiates loader class
// (ie. search and replace 'gfo_' with 'my_plugin_' function namespace)
...
if ( !class_exists( 'gfo_loader' ) ) {
	...
	class gfo_loader {
		...
		public function notice_boxer() {
			...
			if ( isset( $GLOBALS['gfo_data']['load']['notices'] ) && $GLOBALS['gfo_data']['load']['notices'] ) {
				return;
			}
...
add_action( 'plugins_loaded', 'gfo_load_prefixed_functions', 0 );

if ( !function_exists( 'gfo_load_prefixed_functions' ) ) {
	function gfo_load_prefixed_functions() {
		...
		if ( !function_exists( 'gfo_get_namespace_from_function' ) ) {
			function gfo_get_namespace_from_function( $f ) {
		...
		if ( !function_exists( 'gfo_loader_instance' ) ) {
			function gfo_loader_instance() {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'gfo_freemius_instance' ) ) {
			function gfo_freemius_instance() {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'gfo_plugin_data' ) ) {
			function gfo_plugin_data() {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'gfo_plugin_version' ) ) {
			function gfo_plugin_version() {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Set Pro Namespace
		// -----------------
		if ( !function_exists( 'gfo_pro_namespace' ) ) {
			function gfo_pro_namespace( $pronamespace ) {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Add Settings
		// ------------
		if ( !function_exists( 'gfo_add_settings' ) ) {
			function gfo_add_settings() {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Defaults
		// ------------
		if ( !function_exists( 'gfo_default_settings' ) ) {
			function gfo_default_settings( $key = false ) {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Options
		// -----------
		if ( !function_exists( 'gfo_get_options' ) ) {
			function gfo_get_options() {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Setting
		// -----------
		if ( !function_exists( 'gfo_get_setting' ) ) {
		...
		if ( !function_exists( 'gfo_get_settings' ) ) {
			function gfo_get_settings( $filter = true ) {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Reset Settings
		// --------------
		if ( !function_exists( 'gfo_reset_settings' ) ) {
		...
		// Update Settings
		// ---------------
		if ( !function_exists( 'gfo_update_settings' ) ) {
		...
		// Delete Settings
		// ---------------
		if ( !function_exists( 'gfo_delete_settings' ) ) {
			function gfo_delete_settings() {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Message Box
		// -----------
		if ( !function_exists( 'gfo_message_box' ) ) {
			function gfo_message_box( $message, $echo = false ) {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Settings Header
		// ---------------
		if ( !function_exists( 'gfo_settings_header' ) ) {
			function gfo_settings_header() {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Settings Page
		// -------------
		if ( !function_exists( 'gfo_settings_page' ) ) {
		...
		if ( !function_exists( 'gfo_settings_table' ) ) {
			function gfo_settings_table() {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'gfo_settings_row' ) ) {
			function gfo_settings_row( $option, $setting ) {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'gfo_settings_resources' ) ) {
			function gfo_settings_resources( $media, $color_picker ) {
				$namespace = gfo_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
